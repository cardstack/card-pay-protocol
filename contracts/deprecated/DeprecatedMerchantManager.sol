// TODO Delete this contract after we have upgrade all of its merchant safes to
// the new MerchantManager
...
contract DeprecatedMerchantManager is Ownable, Versionable, Safe {
  event Setup();
