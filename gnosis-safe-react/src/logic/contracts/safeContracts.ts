...
// MasterCopy
export const SAFE_MASTER_COPY_ADDRESS = '0x8BFa76AF1fd404F1EDB8460E7092b1150f2A6E6C'
// FallbackManager
export const DEFAULT_FALLBACK_HANDLER_ADDRESS = '0x3409631bc240FE0deBF8976155F20d7854a00B55'
// MasterCopy
export const SAFE_MASTER_COPY_ADDRESS_V10 = '0x8BFa76AF1fd404F1EDB8460E7092b1150f2A6E6C'
...
const createGnosisSafeContract = (web3: Web3, networkId: ETHEREUM_NETWORK) => {
  ...
  // GnosisSafe
  const contractAddress = networks[networkId]?.address ?? REACT_APP_NETWORK === "sokol" ? "0x8042D8D098a31F34Bfb74dDB16ceC1840B41B9bc" : networks[ETHEREUM_NETWORK.MAINNET].address
...
const createProxyFactoryContract = (web3: Web3, networkId: ETHEREUM_NETWORK): GnosisSafeProxyFactory => {
  ...
  const contractAddress = networks[networkId]?.address ?? REACT_APP_NETWORK === "sokol" ? "0x9b9b8A537a5A1AF08F50F6724E9c2db7Fd9459B4" : networks[ETHEREUM_NETWORK.MAINNET].address
